        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-12">
            ...
            <article className="bg-white border border-slate-100 rounded-2xl p-7 shadow-sm">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3 leading-snug" style={{ fontFamily: "Sora, sans-serif" }}>Global Thermal Paper Market: 2024–2030 Outlook</h2>
            ...
            <article className="bg-white border border-slate-100 rounded-2xl p-7 shadow-sm">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3 leading-snug" style={{ fontFamily: "Sora, sans-serif" }}>EU BPA Regulations: What Distributors Need to Know in 2025</h2>
            ...
            <article className="bg-white border border-slate-100 rounded-2xl p-7 shadow-sm">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3 leading-snug" style={{ fontFamily: "Sora, sans-serif" }}>Next-Generation Thermal Coatings: Beyond BPA</h2>
            ...
            <article className="bg-white border border-slate-100 rounded-2xl p-7 shadow-sm">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3 leading-snug" style={{ fontFamily: "Sora, sans-serif" }}>Sustainability in Thermal Paper: FSC, Recycling & Carbon Footprint</h2>
            ...
            <article className="bg-white border border-slate-100 rounded-2xl p-7 shadow-sm">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3 leading-snug" style={{ fontFamily: "Sora, sans-serif" }}>Building a Profitable Thermal Paper Distribution Business</h2>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[["Private label gross margin", "35–45%"], ["Reseller gross margin", "15–25%"], ["Direct factory cost saving vs. trading co.", "15–25%"], ["Core SKUs covering 80% of revenue", "3–4 SKUs"], ["Minimum volume for direct factory pricing", "5,000 rolls/mo"], ["Typical reorder cycle (restaurant customer)", "Monthly"]].map(([label, value]) => (
                    <div key={label} className="bg-white rounded-lg p-3">
                      ...
                      <div className="text-sm font-bold text-purple-900" style={{ fontFamily: "Sora, sans-serif" }}>{value}</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <article className="bg-white border border-slate-100 rounded-2xl p-7 shadow-sm">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3 leading-snug" style={{ fontFamily: "Sora, sans-serif" }}>FDA Requirements for Thermal Paper in US Food Service</h2>
