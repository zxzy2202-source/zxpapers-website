...
export const metadata: Metadata = {
  ...
  description: "Factory-direct thermal paper rolls for UAE. CIF Jebel Ali, 80×80mm and 57×50mm in stock. Arabic OEM packaging, L/C accepted. AED/USD pricing. ISO 9001 certified.",
