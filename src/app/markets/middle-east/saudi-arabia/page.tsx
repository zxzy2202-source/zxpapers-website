...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Saudi Arabia",
      "item": "https://www.zxpapers.com/markets/middle-east/saudi-arabia"
    }
  ]
};
    ...
    <Layout>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/contact" className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold px-8 py-3 rounded-lg transition-colors flex items-center gap-2">Get CIF Jeddah Quote <ArrowRight className="w-4 h-4" /></Link>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-brand-navy mb-3">Popular Products for Saudi Arabia</h2>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-brand-navy mb-8 text-center">Saudi Arabia Buyer FAQ</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-brand-navy mb-3">Get Your Saudi Arabia CIF Quote</h2>
