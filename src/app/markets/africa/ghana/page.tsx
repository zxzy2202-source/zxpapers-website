...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Ghana",
      "item": "https://www.zxpapers.com/markets/africa/ghana"
    }
  ]
};
export default async function GhanaPage() {
  const heroImage = await getSlotImage("markets:ghana-hero", "");
    ...
    <Layout>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl lg:text-4xl font-bold text-brand-navy-alt mb-4">Most Popular Sizes for Ghana</h2>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-brand-navy-alt mb-4">Ghana FAQ</h2>
          </div>
