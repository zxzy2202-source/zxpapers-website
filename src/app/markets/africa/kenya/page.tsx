...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Kenya",
      "item": "https://www.zxpapers.com/markets/africa/kenya"
    }
  ]
};
    ...
    <Layout>
      ...
      <section className="relative bg-gradient-to-br from-brand-navy-alt via-brand-navy to-brand-navy-light text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <nav className="flex items-center gap-2 text-blue-200 text-sm mb-8 flex-wrap">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white font-medium"><CountryFlag code="KE" label="Kenya" className="w-5 inline-block align-middle" /> Kenya</span>
          </nav>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-brand-navy-alt mb-4">Kenya FAQ</h2>
          </div>
      ...
      <section className="py-16 bg-brand-navy-alt">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="text-5xl mb-4"><CountryFlag code="KE" label="Kenya" className="w-12 h-auto" /></div>
