    ...
    <Layout>
      ...
      <section className="bg-slate-50 py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">Shipping to Thailand</h2>
          </div>
      ...
      <section className="bg-white py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">FAQ — Thailand Buyers</h2>
          </div>
      ...
      <section className="bg-[#0F2B5B] text-white py-16">
        <div className="container text-center">
          <h2 className="font-sora text-3xl font-extrabold mb-4">Get CIF Laem Chabang Pricing Today</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href={`${SITE.whatsappUrl}?text=${encodeURIComponent("Hello, I am a distributor in Thailand. Please send me your thermal paper price list and CIF Laem Chabang rates.")}`} target="_blank" rel="noopener noreferrer" className="font-sora inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white font-bold px-8 py-4 rounded-xl transition-all hover:-translate-y-0.5">
