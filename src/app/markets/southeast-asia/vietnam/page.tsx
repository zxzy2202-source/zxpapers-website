...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Vietnam",
      "item": "https://www.zxpapers.com/markets/southeast-asia/vietnam"
    }
  ]
};
    ...
    <Layout>
      ...
      <section className="bg-white py-16">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">Popular Products for Vietnam</h2>
      ...
      <section className="bg-slate-50 py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">Shipping to Vietnam</h2>
          </div>
      ...
      <section className="bg-white py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">FAQ — Vietnam Buyers</h2>
          </div>
      ...
      <section className="bg-brand-navy text-white py-16">
        <div className="container text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href={`${SITE.whatsappUrl}?text=${encodeURIComponent("Hello, I am a distributor in Vietnam. Please send me your thermal paper price list and CIF Ho Chi Minh rates.")}`} target="_blank" rel="noopener noreferrer" className="font-sora inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white font-bold px-8 py-4 rounded-xl transition-all hover:-translate-y-0.5">
