...
export default async function MalaysiaPage() {
  const heroImage = await getSlotImage(
    ...
    "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?w=1400&q=80"
  );
    ...
    <Layout>
      ...
      <section className="bg-white py-16">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">Popular Products for Malaysia</h2>
      ...
      <section className="bg-slate-50 py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">Shipping to Malaysia</h2>
          </div>
      ...
      <section className="bg-white py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="font-sora text-3xl font-extrabold text-slate-900 mb-3">FAQ — Malaysia Buyers</h2>
          </div>
      ...
      <section className="bg-[#0F2B5B] text-white py-16">
        <div className="container text-center">
          <h2 className="font-sora text-3xl font-extrabold mb-4">Get CIF Port Klang Pricing Today</h2>
