...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.zxpapers.com/markets/southeast-asia/malaysia",
      images: [
      {
  ...
  alternates: { canonical: `${SITE.domain}/markets/southeast-asia/malaysia` },
};

const products = [
  { name: "80×80mm Thermal Rolls", badge: "Most Popular", href: "/products/thermal-rolls/80x80mm", desc: "Standard POS receipt roll for Malaysian supermarkets (Giant, Tesco, Aeon), restaurants, and retail chains." },
  { name: "57×50mm Thermal Rolls", badge: "Mobile POS", href: "/products/thermal-rolls/57x50mm", desc: "Compact rolls for handheld POS terminals and delivery receipt printers (GrabFood, Foodpanda)." },
  { name: "4\"×6\" Shipping Labels", badge: "E-Commerce", href: "/products/thermal-labels/4x6-shipping", desc: "High demand from Lazada Malaysia, Shopee MY, and logistics providers (Pos Laju, J&T)." },
  { name: "OEM Custom Rolls", badge: "Private Label", href: "/oem", desc: "Custom logo and packaging for Malaysian distributors and ASEAN re-exporters." },
];

const faqs = [
  { q: "Do you ship CIF to Port Klang?", a: "Yes. We provide CIF Port Klang pricing. Transit time is approximately 10–14 days from Shenzhen." },
  { q: "Can I get FORM E for Malaysia?", a: "Yes. FORM E (ASEAN-China FTA Certificate of Origin) is available to help reduce import duties." },
  { q: "Can I use Malaysia as a re-export hub for ASEAN?", a: "Yes. Many of our Malaysian customers re-distribute to Singapore, Brunei, and other ASEAN markets from Port Klang." },
  { q: "Do you have Halal-compatible products?", a: "Our thermal paper rolls are BPA-free and do not contain animal-derived ingredients. Please contact us for specific Halal documentation requirements." },
];
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Malaysia",
      "item": "https://www.zhixinpaper.com/markets/southeast-asia/malaysia"
    }
  ]
};
  ...
  return (
    <Layout>
      ...
      <PageHero
        ...
        ctas={[
          { label: "Get Malaysia Price List", href: "/contact", variant: "primary", icon: <MessageSquare className="w-4 h-4" /> },
          { label: "WhatsApp for Quote", href: `${SITE.whatsappUrl}?text=${encodeURIComponent("Hello, I am a distributor in Malaysia. Please send me your thermal paper price list and CIF Port Klang rates.")}`, variant: "whatsapp", icon: <Phone className="w-4 h-4" />, external: true },
        ]}
        stats={[
      ...
      <section className="bg-white py-16">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-3" style={{ fontFamily: "Sora, sans-serif" }}>Popular Products for Malaysia</h2>
            <p className="text-slate-500 max-w-xl mx-auto">Most-ordered thermal paper products by Malaysian distributors and ASEAN re-exporters.</p>
          </div>
            ...
            {products.map((p) => (
              <div key={p.name} className="bg-white border border-slate-200 hover:border-green-300 hover:shadow-lg rounded-2xl p-6 transition-all duration-300 flex flex-col">
                ...
                <div className="flex gap-2 mt-auto">
                  ...
                  <a href={`${SITE.whatsappUrl}?text=${encodeURIComponent(`Hello, I need pricing for ${p.name} for Malaysia. Please send MOQ and bulk price.`)}`} target="_blank" rel="noopener noreferrer" className="flex-1 text-center text-sm font-semibold text-white bg-green-600 hover:bg-green-700 px-3 py-2 rounded-lg transition-colors">WhatsApp</a>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-slate-50 py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-3" style={{ fontFamily: "Sora, sans-serif" }}>Shipping to Malaysia</h2>
          </div>
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
            {[
              { label: "Destination Port", value: "Port Klang (Westport / Northport)", icon: <Ship className="w-4 h-4 text-blue-500" /> },
              { label: "Transit Time", value: "10–14 days from Shenzhen", icon: <Clock className="w-4 h-4 text-green-500" /> },
              { label: "Incoterm", value: "FOB Shenzhen / CIF Port Klang", icon: <Package className="w-4 h-4 text-amber-500" /> },
      ...
      <section className="bg-white py-16">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-3" style={{ fontFamily: "Sora, sans-serif" }}>FAQ — Malaysia Buyers</h2>
          </div>
      ...
      <section className="bg-[#0F2B5B] text-white py-16">
        <div className="container text-center">
          <h2 className="text-3xl font-extrabold mb-4" style={{ fontFamily: "Sora, sans-serif" }}>Get CIF Port Klang Pricing Today</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href={`${SITE.whatsappUrl}?text=${encodeURIComponent("Hello, I am a distributor in Malaysia. Please send me your thermal paper price list and CIF Port Klang rates.")}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white font-bold px-8 py-4 rounded-xl transition-all hover:-translate-y-0.5" style={{ fontFamily: "Sora, sans-serif" }}>
