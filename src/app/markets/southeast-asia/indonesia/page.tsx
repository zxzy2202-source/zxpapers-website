...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.zxpapers.com/markets/southeast-asia/indonesia",
      images: [
      {
  ...
  alternates: { canonical: `${SITE.domain}/markets/southeast-asia/indonesia` },
};

const products = [
  { name: "57×50mm Thermal Rolls", badge: "Most Popular", href: "/products/thermal-rolls/57x50mm", desc: "Most popular size in Indonesia for Moka POS, iReap, and mobile payment terminals (GoPay, OVO, DANA)." },
  { name: "80×80mm Thermal Rolls", badge: "Supermarket", href: "/products/thermal-rolls/80x80mm", desc: "Standard POS receipt roll for Indomaret, Alfamart, and large retail chains." },
  { name: "4\"×6\" Shipping Labels", badge: "E-Commerce", href: "/products/thermal-labels/4x6-shipping", desc: "High demand from Tokopedia, Shopee, and Lazada fulfillment centers across Java and Sumatra." },
  { name: "OEM Custom Rolls", badge: "Private Label", href: "/oem", desc: "Custom logo and packaging for Indonesian distributors building their own brand." },
];

const faqs = [
  { q: "Do you ship CIF to Tanjung Priok?", a: "Yes. We provide CIF Tanjung Priok (Jakarta) pricing. Transit time is approximately 14–18 days from Shenzhen." },
  { q: "Can I get FORM E for Indonesia?", a: "Yes. FORM E (ASEAN-China FTA Certificate of Origin) is available to help reduce import duties under the ACFTA agreement." },
  { q: "Do you have SNI certification?", a: "Our products meet international quality standards (ISO 9001, SGS tested). Please contact us for specific SNI documentation requirements." },
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Indonesia",
      "item": "https://www.zhixinpaper.com/markets/southeast-asia/indonesia"
    }
  ]
};
export default function IndonesiaPage() {
  return (
    <Layout>
      ...
      />
      <PageHero
        bgImage="https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=1400&q=80"
        overlayDir="left"
        overlayOpacity={50}
        breadcrumbs={[
          { label: "Home", href: "/" },
        ...
        ctas={[
          { label: "Get Indonesia Price List", href: "/contact", variant: "primary", icon: <MessageSquare className="w-4 h-4" /> },
          { label: "WhatsApp for Quote", href: `${SITE.whatsappUrl}?text=${encodeURIComponent("Hello, I am a distributor in Indonesia. Please send me your thermal paper price list and CIF Tanjung Priok rates.")}`, variant: "whatsapp", icon: <Phone className="w-4 h-4" />, external: true },
        ]}
        stats={[
            ...
            {products.map((p) => (
              <div key={p.name} className="bg-white border border-slate-200 hover:border-green-300 hover:shadow-lg rounded-2xl p-6 transition-all duration-300 flex flex-col">
                ...
                <div className="flex gap-2 mt-auto">
                  ...
                  <a href={`${SITE.whatsappUrl}?text=${encodeURIComponent(`Hello, I need pricing for ${p.name} for Indonesia. Please send MOQ and bulk price.`)}`} target="_blank" rel="noopener noreferrer" className="flex-1 text-center text-sm font-semibold text-white bg-green-600 hover:bg-green-700 px-3 py-2 rounded-lg transition-colors">WhatsApp</a>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-slate-50 py-16">
        <div className="container max-w-3xl">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
            {[
              { label: "Destination Port", value: "Tanjung Priok, Jakarta", icon: <Ship className="w-4 h-4 text-blue-500" /> },
              { label: "Transit Time", value: "14–18 days from Shenzhen", icon: <Clock className="w-4 h-4 text-green-500" /> },
              { label: "Incoterm", value: "FOB Shenzhen / CIF Tanjung Priok", icon: <Package className="w-4 h-4 text-amber-500" /> },
