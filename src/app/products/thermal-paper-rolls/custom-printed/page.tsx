...
const productSchema = { "@context": "https://schema.org", "@type": "WebPage", name: "Custom Printed Thermal Paper Rolls", description: metadata.description, image: FALLBACK, url: `${SITE.domain}/products/thermal-paper-rolls/custom-printed`, about: { "@type": "Thing", name: "Custom Printed Thermal Paper Rolls" } };
