...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Custom Printed",
      "item": "https://www.zxpapers.com/products/detergent-labels/custom-printed"
    }
  ]
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Custom Printed Detergent Labels | OEM Cleaning Product Labels",
  ...
  "about": { "@type": "Thing", "name": "Custom Printed Detergent Labels" },
};
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  "Water-resistant and chemical-resistant substrates",
                  "Gloss, matte, soft-touch lamination, and spot UV",
                  "Embossing, debossing, and hot foil stamping",
                  "NDA and IP protection for all artwork",
                  "Free design support and pre-press proofing",
                  "GHS / CLP compliant hazard label printing",
