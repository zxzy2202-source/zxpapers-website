        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <img src={LABELS_IMG} alt="Blank Thermal Labels" className="w-full sm:w-72 h-52 object-cover rounded-2xl flex-shrink-0 shadow-md" />
              <div>
                ...
                <h1 className="text-3xl font-extrabold text-slate-900 mb-3 leading-tight" style={{ fontFamily: "Sora, sans-serif" }}>Blank Thermal Labels</h1>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-4" style={{ fontFamily: "Sora, sans-serif" }}>Industry Applications</h2>
                ...
                {industries.map(({ sector, icon, apps }) => (
                  <div key={sector} className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="font-bold text-slate-900 text-sm" style={{ fontFamily: "Sora, sans-serif" }}>{sector}</span>
                    </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-bold text-slate-900" style={{ fontFamily: "Sora, sans-serif" }}>Full Specifications</h2>
              </div>
