...
const EXACT: Record<string, string> = {
  ...
  "/products/thermal-labels/custom-printed": "定制热敏标签",
  ...
  "/products/can-labels": "灌装包装标签 Beverage & Food Packaging Labels",
  "/products/can-labels/blank": "空白灌装包装标签",
  "/products/can-labels/custom-printed": "定制灌装包装标签",
