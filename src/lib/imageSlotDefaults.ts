...
const SHIPPING_LABELS_HERO_IMAGE = "/images/shipping-labels/shipping-labels-hero.webp";
...
const SHIPPING_LABELS_ROLL_IMAGE = SHIPPING_LABELS_HERO_IMAGE;
const SHIPPING_LABELS_FANFOLD_IMAGE = SHIPPING_LABELS_HERO_IMAGE;
...
const exactDefaults: Record<string, string> = {
  ...
  "linerless-3-1-8-x-263:hero": THERMAL_LABELS_IMAGE,
  "linerless-3-1-8-x-263:application": THERMAL_LABELS_IMAGE,
  "linerless-3-1-8-x-263:quality": FACTORY_LINE_IMAGE,
