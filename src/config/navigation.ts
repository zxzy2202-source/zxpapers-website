...
export const mainNav: (NavItem | NavDropdown)[] = [
  { label: "Home", href: "/" },
  {
    ...
    { label: "Custom Printed Thermal Rolls",     href: "/products/thermal-paper-rolls/custom-printed" },
      ...
      { label: "3 1/8 × 263' Linerless",           href: "/products/linerless-labels/3-1-8-x-263" },
    ...
    productGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Shipping Labels",              href: "/products/shipping-labels" },
          { label: "Linerless Labels",             href: "/products/linerless-labels" },
          { label: "3 1/8 × 263' Linerless",       href: "/products/linerless-labels/3-1-8-x-263", badge: "Detail", badgeColor: "amber" },
          { label: "Barcode Labels",               href: "/products/barcode-labels" },
          { label: "Product Labels",               href: "/products/product-labels" },
        ],
      },
      {
        groupLabel: "Packaging Labels",
        href: "/products/can-labels",
        description: "Beverage, food, bottle and filled-product packaging labels.",
        badge: "OEM",
        badgeColor: "green",
        items: [
          { label: "Beverage & Food Packaging Labels", href: "/products/can-labels" },
...
export const footerLinks = {
  ...
  popularSizes: [
    ...
    { label: "211×400 Packaging Labels",   href: "/products/can-labels/211x400" },
    { label: "300×407 Packaging Labels",   href: "/products/can-labels/300x407" },
