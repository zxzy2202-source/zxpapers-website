...
export const thermalRoll80x70Config = createThermalRollDetailConfig({
  ...
  metadataDescription: "Source 80x70mm POS thermal paper rolls for retail, hospitality and compact receipt systems across Africa, the Middle East and Southeast Asia. Review printer fit, real length, paper grade, OEM packing and logistics.",
  keywords: ["80x70mm thermal paper rolls", "80mm POS receipt paper", "compact POS paper rolls", "3 1/8 inch thermal paper", "OEM thermal rolls", "wholesale receipt paper"],
  heroSlot: "thermal-roll-80x70mm:hero",
  heroDescription: "For distributors, retail groups and hospitality suppliers across Africa, the Middle East and Southeast Asia seeking an 80 mm roll with a 70 mm profile. Confirm printer clearance, length basis, paper grade, documentation, packing and destination.",
  ...
  buyerFit: "Distributors, retail chains and hospitality supply programs across Africa, the Middle East and Southeast Asia",
  markets: ["Africa", "Middle East", "Southeast Asia"],
  rollSpecification: [
  ...
  applications: [
    { title: "Compact POS systems", description: "Full-width receipts in retail and service environments using a compact roll profile.", confirm: "printer model, 70 mm OD clearance, core and local receipt requirements" },
