...
export const IMAGE_SLOTS = [
  ...
  { slot: "ncr-receipt-books:hero", label: "NCR Receipt Books - Hero", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "16:9", description: "Finished receipt books or a real receipt-writing scene for the procurement hero." },
  { slot: "ncr-receipt-books:overview", label: "NCR Receipt Books - Product Definition", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "1:1", description: "Product definition and quotation checklist image." },
  { slot: "ncr-receipt-books:buyer-risk", label: "NCR Receipt Books - Buyer Risks", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "4:3", description: "Copy clarity, numbering, binding, and repeat-order risk image." },
  { slot: "ncr-receipt-books:2-part", label: "NCR Receipt Books - 2-Part", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "4:3", description: "Duplicate 2-part receipt book program." },
  { slot: "ncr-receipt-books:3-part", label: "NCR Receipt Books - 3-Part", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "4:3", description: "Triplicate 3-part receipt book program." },
  { slot: "ncr-receipt-books:private-label", label: "NCR Receipt Books - Private Label", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "4:3", description: "Custom covers, buyer fields, and distributor SKU program." },
  { slot: "ncr-receipt-books:production", label: "NCR Receipt Books - Production", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "4:3", description: "Paper layers, numbering, perforation, and book-count quality control." },
  { slot: "ncr-receipt-books:packing", label: "NCR Receipt Books - Packing", page: "NCR Receipt Books", pageUrl: "/products/ncr-receipt-books", aspect: "4:3", description: "Book labels, shrink wrapping, inner packs, and export cartons." },
